  ...
  task :populate => :environment do
    ...
    puts "creating 10 users..."  
      ...
      100.times do
        ...
        user = User.new(location: "Vancouver, British Columbia", first_name: first_name, birthday: birthday, last_name: last_name, email: email, gender: genders.sample, password: '12341234', image: image)
        if user.save
